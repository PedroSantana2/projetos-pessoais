...
def computador(lista):
    print('\t[ / ] Vez do computador!')
    print('\t[ / ] Computador está pensando...')
    time.sleep(1.8)
    while True:
        numero = random.randint(0, 8)
        if lista[numero] == '\x1b[1;32mX\x1b[m' or lista[numero] == '\x1b[1;31mO\x1b[m':
            continue
        else:
            return lista[numero]
